...
-- ----------------------------
-- Table structure for activity (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for adopt (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for animal (SQLite Format)
-- ----------------------------
...
CREATE TABLE animal (
  ...
  sterilization TEXT DEFAULT NULL,
  vaccine TEXT DEFAULT NULL,
  adopt TEXT DEFAULT NULL,
  information TEXT DEFAULT NULL,
  is_adopt TEXT DEFAULT NULL,
...
-- ----------------------------
-- Table structure for applcation (SQLite Format)
-- ----------------------------
...
CREATE TABLE applcation (
  ...
  state TEXT DEFAULT 'under review',
...
-- ----------------------------
-- Table structure for article (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for article_kp (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for comment (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for donate (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for feed (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for lost (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for notice (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for rescue (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for salvation (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sterilization (SQLite Format)
-- ----------------------------
DROP TABLE IF EXISTS sterilization;
CREATE TABLE sterilization (
  id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  animal_id INTEGER DEFAULT NULL,
  catch1 TEXT DEFAULT NULL,
  sterilization TEXT DEFAULT NULL,
  release1 TEXT DEFAULT NULL,
  vaccine TEXT DEFAULT NULL,
...
-- ----------------------------
-- Table structure for sys_dict (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_file (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_menu (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_role (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_role_menu (SQLite Format)
-- ----------------------------
...
-- ----------------------------
-- Table structure for sys_user (SQLite Format)
-- ----------------------------
