<template>
  <div style="margin: 10px 0">
    <el-table :data="tableData" stripe style="border-radius: 10px">
      <el-table-column label="1"><template slot-scope="scope"><el-image style="width: 100px; height: 100px" :src="$store.state.baseApi+scope.row.img" :preview-src-list="[$store.state.baseApi + scope.row.img]"></el-image></template></el-table-column>
      <el-table-column label="2"><template slot-scope="scope"><el-image style="width: 100px; height: 100px" :src="$store.state.baseApi+scope.row.img2" :preview-src-list="[$store.state.baseApi + scope.row.img2]"></el-image></template></el-table-column>
      <el-table-column label="3"><template slot-scope="scope"><el-image style="width: 100px; height: 100px" :src="$store.state.baseApi+scope.row.img3" :preview-src-list="[$store.state.baseApi + scope.row.img3]"></el-image></template></el-table-column>
      ...
      <el-form label-width="100px"  style="width: 90%">
        <el-form-item label="1">
          <el-upload :action="$store.state.baseApi+'/file/upload'" ref="img" :on-success="handleImgUploadSuccess">
            <el-button  type="primary"> click here to upload</el-button>
          </el-upload>
        </el-form-item>
