<template>
  <div>
    <div style="margin: 10px 0">
      <el-input style="width: 200px" size="large" placeholder="please type a name" suffix-icon="iconfont icon-r-find" v-model="name"></el-input>
    ...
    <div style="margin: 10px 0">
      ...
      <el-button type="primary" @click="handleAdd"> new added </el-button>
      <el-popconfirm
          class="ml-5"
          confirm-button-text='confirm'
          cancel-button-text='think twice'
          icon="el-icon-info"
          icon-color="red"
          title="Are you sure you want to batch delete these data?"
          @confirm="delBatch"
      >
        <el-button type="danger" slot="reference"> Batch Deletion </el-button>
      </el-popconfirm>
    </div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="content" label="content" width="140">
        <template v-slot="scope">
          <el-button  type="primary" @click="view(scope.row.content)">check</el-button>
        </template>
      </el-table-column>
      <el-table-column prop="time" label="time"></el-table-column>
      <el-table-column label="pic" width="150"><template slot-scope="scope"><el-image style="width: 100px; height: 100px" :src="$store.state.baseApi+scope.row.img" :preview-src-list="[$store.state.baseApi + scope.row.img]"></el-image></template></el-table-column>
      <el-table-column prop="num" label="signed in number"></el-table-column>
      <el-table-column prop="address" label="adddress"></el-table-column>
    ...
    <el-dialog title="info" :visible.sync="dialogFormVisible" width="60%" :close-on-click-modal="false">
      <el-form label-width="100px"  style="width: 90%">
        ...
        <el-form-item label="signed in number">
