<template>
  <div style="padding-bottom: 20px;">
    ...
    <div style="margin: 10px 0; padding: 20px; background-color: #fff; border-radius: 10px">
      <div class="announcement">notice list</div>
    ...
    <div style="margin: 10px 0">
      <div class="wander"> strayed pets</div>
        ...
        <div style="display: flex">
          ...
          <div style="padding-left: 50px; flex: 1">
            ...
            <div style="line-height: 30px">
              <div><b style="margin-right: 10px">species：</b>{{ item.type }}</div>
              <div><b style="margin-right: 10px">activity area：</b>{{ item.address }}</div>
              <div><b style="margin-right: 10px">physical conditons：</b>{{ item.status }}</div>
              <div><b style="margin-right: 10px">others：</b>{{ item.information }}</div>
            </div>
          </div>
        </div>
      </el-card>
