<template>
  <div>
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="animalName" label="strayed animal"></el-table-column>
      <el-table-column prop="catch1" label="catch"></el-table-column>
      <el-table-column prop="sterilization" label="sterilization"></el-table-column>
      <el-table-column prop="release1" label="release"></el-table-column>
      <el-table-column prop="vaccine" label="vaccine"></el-table-column>
    ...
    <el-dialog title="info" :visible.sync="dialogFormVisible" width="30%" :close-on-click-modal="false">
      <el-form label-width="100px"  style="width: 90%">
        <el-form-item label="strayed animal">
        ...
        <el-form-item label="sterilization">
          <el-input v-model="form.sterilization" autocomplete="off" disabled></el-input>
        </el-form-item>
        <el-form-item label="catch">
          <el-radio v-model="form.catch1" label="not catched">not catched</el-radio>
          <el-radio v-model="form.catch1" label="catched">catched</el-radio>
        </el-form-item>
        <el-form-item label="release">
          <el-radio v-model="form.release1" label="unreleased">unreleased</el-radio>
